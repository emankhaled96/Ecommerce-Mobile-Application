...
public final class CartItemsLayoutBinding implements ViewBinding {
  ...
  private CartItemsLayoutBinding(@NonNull CardView rootView, @NonNull ImageView cartProductImage,
      @NonNull TextView cartProductName, @NonNull TextView cartProductPrice,
      @NonNull TextView cartProductQuantity) {
  ...
  public static CartItemsLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CartItemsLayoutBinding((CardView) rootView, cartProductImage, cartProductName,
          cartProductPrice, cartProductQuantity);
    }
